...
<body class="hold-transition skin-blue sidebar-mini">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="box"
									...
									<div class="row">
										<div>
											<input type="button" value="查看用电量曲线" name="sss" id="btn_print"/>
											<input type="button" value="导出用电量" name="btn_import" id="btn_import"/>
										</div>
										<div class="col-md-12">
	...
	$(function(){
		...
		$("#btn_print").click(function(){
       	...
       	$("#btn_import").click(function(){
       		var url = '<%=path%>/callRAction/callRAnalysisSheet.do';
	...
	function ydxwLine(data){
		...
		for(var i = 0 ; i < data.length ; i++){
			...
			console.log(item.user_elec);
			
			var seriesItem = {"type":"line"};
			seriesItem["name"] = item.user_name;
			seriesItem["data"] = item.user_elec.split(",");
			for(var j = seriesItem["data"].length-1 ; j > 0 ; j--){
				seriesItem["data"][j] = seriesItem["data"][j] - seriesItem["data"][j-1];
			}
			seriesItem["data"].splice(0,1);
